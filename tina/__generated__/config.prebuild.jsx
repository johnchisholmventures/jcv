    ...
    collections: [
      {
        ...
        fields: [
          ...
          },
          {
            ...
            ui: {
              description: "Pick the type first. Then fill YouTube ID or external URL if needed."
            }
          },
          {
            type: "string",
            ...
            description: "Only for Video. From youtube.com/watch?v=THIS_PART or youtu.be/THIS_PART"
          },
          {
            type: "string",
            name: "externalUrl",
          ...
          },
          {
            ...
            description: "Lower numbers appear first among featured items. Leave blank if not featured."
          },
          {
            type: "boolean",
            name: "draft",
          ...
          },
          {
            ...
            label: "Body",
            isBody: true,
            description: "Main article text. For videos, a short description is fine."
          }
        ]
      },
      {
